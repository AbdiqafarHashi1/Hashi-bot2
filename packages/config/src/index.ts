...
const envSchema = z.object({
  ...
  MARKET_DATA_TIMEFRAME: timeframeSchema.default("15m"),
  ...
  FOREX_MARKET_CLOSE_UTC: z.string().default("Friday 22:00"),
  ...
  SIGNAL_MIN_TP2_R: z.coerce.number().positive().default(1.25),
  SIGNAL_MAX_ENTRY_STRETCH_ATR: z.coerce.number().positive().default(0.8),
  SIGNAL_SYMBOL_COOLDOWN_MINUTES: z.coerce.number().int().positive().default(20),
  ...
  ENGINE2_MIN_SCORE: z.coerce.number().min(0).max(100).default(50),
  ...
  ENGINE3_MIN_SCORE: z.coerce.number().min(0).max(100).default(48),
  ENGINE3_RANKING_BIAS: z.coerce.number().min(-20).max(20).default(0),
  SIGNAL_ENABLE_ENGINE4: booleanFlagSchema.default(true),
  ENGINE4_STRATEGY: z.enum(["micro_scalp_continuation_v1"]).default("micro_scalp_continuation_v1"),
  ENGINE4_MIN_SCORE: z.coerce.number().min(0).max(100).default(30),
  ENGINE4_RANKING_BIAS: z.coerce.number().min(-20).max(20).default(2),
  ENGINE4_MIN_ATR_PCT: z.coerce.number().min(0).max(1).default(0.05),
  ENGINE4_MAX_CHOP_5M: z.coerce.number().min(0.1).max(1.2).default(0.9),
  ENGINE4_MAX_EXTENSION_ATR: z.coerce.number().min(0.2).max(5).default(3.4),

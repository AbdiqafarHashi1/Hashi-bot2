...
const envSchema = z.object({
  ...
  ENGINE4_MIN_SCORE: z.coerce.number().min(0).max(100).default(36),
  ENGINE4_RANKING_BIAS: z.coerce.number().min(-20).max(20).default(2),
  ENGINE4_MIN_ATR_PCT: z.coerce.number().min(0).max(1).default(0.08),
  ENGINE4_MAX_CHOP_5M: z.coerce.number().min(0.1).max(1.2).default(0.82),
